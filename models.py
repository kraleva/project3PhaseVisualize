...
class Relationship(models.Model):
    user1 = models.ForeignKey('User', models.DO_NOTHING, primary_key=True)
    user2 = models.ForeignKey('User', models.DO_NOTHING)
...
class UserpageUserpage(models.Model):
    username = models.TextField()
    description = models.TextField()

    class Meta:
        managed = False
        db_table = 'userpage_userpage'
